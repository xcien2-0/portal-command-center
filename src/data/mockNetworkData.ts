...
export const MOCK_NODES: NetworkNode[] = [
  ...
  { id: 'n3', name: 'NL-ESCOBEDO-DIST', shortName: 'ESC-DIST', location: 'Escobedo, NL', zone: 'Nuevo León', isp: 'ISP 2', status: 'ok', latency: 3, uptime: 99.8, ip: '10.0.3.1', lastIncident: '2026-01-20', bandwidthUp: 280, bandwidthDown: 350, packetLoss: 0.02, signal: -28, weekHealth: ['ok','ok','ok','ok','ok','ok','ok'] },
  { id: 'n4', name: 'COAH-SALTILLO-CORE', shortName: 'SAL-CORE', location: 'Saltillo, COAH', zone: 'Coahuila', isp: 'ISP Principal', status: 'critical', latency: 210, uptime: 89.1, ip: '10.1.1.1', lastIncident: '2026-03-12', bandwidthUp: 50, bandwidthDown: 80, packetLoss: 5.2, signal: -68, weekHealth: ['ok','ok','ok','warning','warning','critical','critical'] },
  { id: 'n5', name: 'COAH-RAMOS-DIST', shortName: 'RAM-DIST', location: 'Ramos Arizpe, COAH', zone: 'Coahuila', isp: 'ISP Principal', status: 'ok', latency: 5, uptime: 99.7, ip: '10.1.2.1', lastIncident: '2026-02-28', bandwidthUp: 190, bandwidthDown: 250, packetLoss: 0.05, signal: -30, weekHealth: ['ok','ok','ok','ok','ok','ok','ok'] },
  { id: 'n6', name: 'SLP-CAPITAL-CORE', shortName: 'SLP-CORE', location: 'San Luis Potosí, SLP', zone: 'San Luis Potosí', isp: 'ISP 2', status: 'ok', latency: 8, uptime: 99.5, ip: '10.2.1.1', lastIncident: '2026-03-01', bandwidthUp: 420, bandwidthDown: 510, packetLoss: 0.1, signal: -25, weekHealth: ['ok','ok','ok','ok','ok','ok','ok'] },
  { id: 'n7', name: 'SLP-SOLEDAD-DIST', shortName: 'SOL-DIST', location: 'Soledad de G.S., SLP', zone: 'San Luis Potosí', isp: 'Sandur', status: 'warning', latency: 67, uptime: 95.3, ip: '10.2.2.1', lastIncident: '2026-03-11', bandwidthUp: 150, bandwidthDown: 200, packetLoss: 1.5, signal: -52, weekHealth: ['ok','warning','ok','ok','warning','warning','warning'] },
  { id: 'n8', name: 'NL-GARCIA-DIST', shortName: 'GAR-DIST', location: 'García, NL', zone: 'Nuevo León', isp: 'ISP 3', status: 'ok', latency: 4, uptime: 99.9, ip: '10.0.4.1', lastIncident: '2026-01-15', bandwidthUp: 210, bandwidthDown: 270, packetLoss: 0.02, signal: -26, weekHealth: ['ok','ok','ok','ok','ok','ok','ok'] },
  ...
  { id: 'n10', name: 'NL-SANTA-CATARINA', shortName: 'STC-DIST', location: 'Santa Catarina, NL', zone: 'Nuevo León', isp: 'ISP 3', status: 'ok', latency: 3, uptime: 99.8, ip: '10.0.5.1', lastIncident: '2026-02-20', bandwidthUp: 260, bandwidthDown: 310, packetLoss: 0.03, signal: -29, weekHealth: ['ok','ok','ok','ok','ok','ok','ok'] },
];
