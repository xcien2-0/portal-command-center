...
export const MOCK_NODES: NetworkNode[] = [
  ...
  { id: 'n8', name: 'NL-GARCIA-DIST', shortName: 'GAR-DIST', location: 'García, NL', zone: 'Nuevo León', isp: 'Huus', status: 'ok', latency: 4, uptime: 99.9, ip: '10.0.4.1', lastIncident: '2026-01-15', bandwidthUp: 210, bandwidthDown: 270, packetLoss: 0.02, signal: -26, weekHealth: ['ok','ok','ok','ok','ok','ok','ok'] },
  ...
  { id: 'n10', name: 'NL-SANTA-CATARINA', shortName: 'STC-DIST', location: 'Santa Catarina, NL', zone: 'Nuevo León', isp: 'Huus', status: 'ok', latency: 3, uptime: 99.8, ip: '10.0.5.1', lastIncident: '2026-02-20', bandwidthUp: 260, bandwidthDown: 310, packetLoss: 0.03, signal: -29, weekHealth: ['ok','ok','ok','ok','ok','ok','ok'] },
];
